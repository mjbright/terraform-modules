...
locals {
  ...
  # For Debian:
  debian_account_number    = "379101102735"
  # For Ubuntu:
...
data "aws_ami" "centos8" {
  ...
  #count       = ( var.num_groups > 0 ? 1 : var. ami_family = "centos8" )
  #count       = ( var.num_groups > 0 ? 1 : 0 )
...
data "aws_ami" "centos7" {
  ...
  #count       = ( var.num_groups > 0 ? 1 : var. ami_family = "centos7" )
  #count       = ( var.num_groups > 0 ? 1 : 0 )
...
data "aws_ami" "centos6" {
  ...
  #count       = ( var.num_groups > 0 ? 1 : var. ami_family = "centos6" )
  #count       = ( var.num_groups > 0 ? 1 : 0 )
...
data "aws_ami" "amazon2" {
  ...
  #count       = ( var.num_groups > 0 ? 1 : var. ami_family = "amazon2" )
  #count       = ( var.num_groups > 0 ? 1 : 0 )
